...
# %% ### Load Data ###
data = torch.from_numpy(np.load("/project/aoberai_286/ihlee/Wildfire_Research/data/training_testing_data_for_predicting_fire_area_from_ign_time_conditions_ln.npy")).float()
data_test_real = torch.from_numpy(np.load("/project/aoberai_286/ihlee/Wildfire_Research/data/real_fire_data_ln.npy")).float()
...
path_to_run = '/project/aoberai_286/ihlee/fire_area_prediction/wildfire_results_real_ln/' + expname + '/'
