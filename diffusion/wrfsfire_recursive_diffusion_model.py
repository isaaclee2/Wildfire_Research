...
path_to_run = '/project2/aoberai_286/ihlee/Wildfire_Research/wrfsfire_recursive_wildfire_results/' + expname + '/'
...
condition_matrix = np.load("/project2/aoberai_286/ihlee/Wildfire_Research/data/recursive_test_data.npy") 
...
np.savez(path_to_run + 'wrfsfire_fire_area_matrix.npz', fire_area_matrix)
