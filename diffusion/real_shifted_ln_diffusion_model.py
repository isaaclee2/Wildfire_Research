...
# %% ### Load Data ###
data = torch.from_numpy(np.load("/project/aoberai_286/ihlee/Wildfire_Research/data/training_testing_data_ln_shifted.npy")).float()
data_test_real = torch.from_numpy(np.load("/project/aoberai_286/ihlee/Wildfire_Research/data/real_fire_data_ln_shifted.npy")).float()
...
path_to_run = '/project/aoberai_286/ihlee/fire_area_prediction/wildfire_results_real_shifted_ln/' + expname + '/'
