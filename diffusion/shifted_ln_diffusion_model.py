...
# %% ### Load Data ###
data = torch.from_numpy(np.load("/project/aoberai_286/ihlee/Wildfire_Research/training_testing_data_ln_shifted.npy")).float()
...
path_to_run = '/project/aoberai_286/ihlee/Wildfire_Research/wildfire_results_shifted_ln/' + expname + '/'
