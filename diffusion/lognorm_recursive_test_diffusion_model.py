...
# %% ### Load Data ###
train_data = torch.from_numpy(np.load("/project2/aoberai_286/ihlee/Wildfire_Research/data/lognorm_recursive_train_data_norm.npy")).float()
test_data  = torch.from_numpy(np.load("/project2/aoberai_286/ihlee/Wildfire_Research/data/lognorm_recursive_test_data_norm.npy")).float()
...
path_to_run = '/project2/aoberai_286/ihlee/Wildfire_Research/lognorm_wildfire_results/' + expname + '/'
